	...
	{	
		...
		foreach ($dom->find('body font p') as $p)
		{
			...
			foreach ($p->find('table tbody tr') as $tr)
			{
				...
				if (preg_match('/(?<title><b>(Advertisement|An apology|Announcements|Author [I|i]ndex|Index to fungous and lichen taxa|Content|Errata|Errata and Addenda|Erratum|Guidelines for reviewers|Guidelines for reviewers of papers submitted for publication in Mycotaxon|Index|Index to fungous and lichen taxa|Instructions to [A|a]uthors|Instructions to authors \(revised October 2000\)|Instructions to authors: important changes and updates|Instructions to authors and author\'s checklist|Journal Publication Statements?|Missing|Mycotaxon|Mycotaxon publication dates?|Nomenclatural novelties|Nomenclatural novelties proposed in volume seventy-two|Nomenclatural novelties proposed in Mycotaxon volume 89|Notices?|Ownership Statement|Publication [D|d]ate|Preface|Publication [D|d]ates? [F|f]or Mycotaxon|Remembering the morel grower: Ron Ower, 1939-1986|Reviewers|Revised instructions to authors|Statement [O|o]f [O|o]wnership|Table of Contents)\.?<\/b>.*)\s+Pages?/u', $tr->outertext, $m))
				{
